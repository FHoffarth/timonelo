...
class CruiseBriefingSynthesizer:
    ...
    def generate_briefing(
        ...
        overhead_desc = sandwich.overhead_layer.deck_name if sandwich and sandwich.overhead_layer else "Residential Deck"
        underfoot_desc = sandwich.underfoot_layer.deck_name if sandwich and sandwich.underfoot_layer else "Residential Deck"
        sandwich_status = f"Deck above: {overhead_desc} | Deck below: {underfoot_desc} (Pure residential buffer)"
        ...
        visa_intel = VisaIntelligenceEvaluator.evaluate(port_intel.country, visa_override)
        dining_intel = DiningIntelligenceEvaluator.evaluate(ontology, target_cabin, router, dining_override)
        travel_intel = TravelIntelligenceEvaluator.evaluate(port_intel.country, travel_override)
        ...
        all_evidence = list(target_cabin.evidence_links) + port_intel.evidence_links + weather_intel.evidence_links
